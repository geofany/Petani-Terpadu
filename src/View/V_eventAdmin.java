 ...
 * @author GeGa
 */
public class V_eventAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tambahEventBtn = new javax.swing.JPanel();
        tambahEventBaru = new javax.swing.JLabel();
        ...
        tambahEventBtn.setBackground(new java.awt.Color(51, 51, 51));
        tambahEventBtn.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
        tambahEventBtn.setForeground(new java.awt.Color(26, 26, 26));
        tambahEventBtn.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        tambahEventBaru.setFont(new java.awt.Font("Dialog", 0, 24)); // NOI18N
        tambahEventBaru.setForeground(new java.awt.Color(255, 255, 255));
        tambahEventBaru.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/tambah blank.png"))); // NOI18N
        tambahEventBaru.setText(" TAMBAH EVENT BARU");
        tambahEventBtn.add(tambahEventBaru, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 20, -1, -1));

        jPanel22.add(tambahEventBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 1310, 70));
        ...
        jPanel5.add(judul2, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 10, 910, 60));

        tanggal2.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        tanggal2.setForeground(new java.awt.Color(255, 255, 255));
        tanggal2.setText("30 September 2019");
        jPanel5.add(tanggal2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 20, -1, 30));
        ...
        tanggal1.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        tanggal1.setForeground(new java.awt.Color(255, 255, 255));
        tanggal1.setText("30 September 2019");
        jPanel6.add(tanggal1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 20, -1, 30));
        ...
        jPanel6.add(judul1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 10, 910, 60));
        ...
        jPanel7.add(judul3, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 10, 910, 60));

        tanggal3.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        tanggal3.setForeground(new java.awt.Color(255, 255, 255));
        tanggal3.setText("30 September 2019");
        jPanel7.add(tanggal3, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 20, -1, 30));
        ...
        jPanel8.add(judul4, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 10, 910, 60));

        tanggal4.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        tanggal4.setForeground(new java.awt.Color(255, 255, 255));
        tanggal4.setText("30 September 2019");
        jPanel8.add(tanggal4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 20, -1, 30));
        ...
        jPanel9.add(judul5, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 10, 910, 60));

        tanggal5.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        tanggal5.setForeground(new java.awt.Color(255, 255, 255));
        tanggal5.setText("30 September 2019");
        jPanel9.add(tanggal5, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 20, -1, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(V_eventAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new V_eventAdmin().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel tambahEventBaru;
    private javax.swing.JPanel tambahEventBtn;
